...
public class StepFunction implements RequestHandler<DynamodbEvent, String> {
		...
		for (DynamodbStreamRecord record : event.getRecords()) {
			if (record.getEventName().equals("INSERT")) {
				...
				StartExecutionRequest startExecutionRequest = new StartExecutionRequest()
						.withStateMachineArn("arn:aws:states:us-east-2:302807701576:stateMachine:TestFinal");
				try {
